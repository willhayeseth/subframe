import{cD as P,df as l,cG as w,cH as I,cI as A,cY as v,cP as h,cJ as u,d2 as z,cV as N,cR as $,c_ as M,dn as K,cW as F,cX as Q,cE as O,cF as H,dM as L}from"./index-B03atDMB.js";import{S as r}from"./SwapController-CoCNWMQG.js";import"./index-FIq3Kgz2.js";const q={numericInputKeyDown(e,t,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=e.metaKey||e.ctrlKey,i=e.key,a=i.toLocaleLowerCase(),c=a==="a",C=a==="c",V=a==="v",W=a==="x",E=i===",",_=i===".",R=i>="0"&&i<="9";!s&&(c||C||V||W)&&e.preventDefault(),t==="0"&&!E&&!_&&i==="0"&&e.preventDefault(),t==="0"&&R&&(o(i),e.preventDefault()),(E||_)&&(t||(o("0."),e.preventDefault()),(t?.includes(".")||t?.includes(","))&&e.preventDefault()),!R&&!n.includes(i)&&!_&&!E&&e.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
